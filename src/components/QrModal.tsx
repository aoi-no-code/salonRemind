  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-md mx-auto p-6">
        <h2 className="text-xl font-bold text-gray-900 mb-2">公式LINEを友だち追加</h2>
        ...
        <div className="space-y-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white font-medium px-4 py-2 rounded-md"
          >
            LINEを開いて友だち追加
          </a>
          {linkUrl && (
            <a
              href={linkUrl}
              className="w-full inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded-md"
            >
              友だち追加後に連携する
            </a>
          )}
